...
namespace VinylTown.Data.Migrations
{
    ...
    [Migration("20230622104653_AddOrderConfiguration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VinylTown.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("VinylTown.Domain.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CostumerCartId");

                    b.ToTable("CartItems");
                });

            modelBuilder.Entity("VinylTown.Domain.CostumerCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CostumerCarts");
                });

            modelBuilder.Entity("VinylTown.Domain.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VinylTown.Domain.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VinylTown.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VinylTown.Domain.CartItem", b =>
                {
                    b.HasOne("VinylTown.Domain.CostumerCart", "CostumerCart")
                        .WithMany("Items")
                        .HasForeignKey("CostumerCartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CostumerCart");
                });

            modelBuilder.Entity("VinylTown.Domain.OrderItem", b =>
                {
                    b.HasOne("VinylTown.Domain.Order", "Order")
                        .WithMany("OrderItems")
